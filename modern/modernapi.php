...
require_once ('../php/commonutils.php');
require_once ('../php/admin.php');
require_once ('../php/queuecontent.php');
require_once ('../php/products.php');
require_once ('../php/roomtables.php');
require_once ('../php/ordersmanagement.php');
require_once ('../php/bill.php');
require_once ('../php/printqueue.php');
require_once ('../php/workreceipts.php');
require_once ('../php/hotelinterface.php');
require_once ('../php/rksv.php');
require_once ('../php/utilities/userrights.php');
require_once ('../php/utilities/permissions.php');
require_once ('../php/utilities/orders.php');
require_once ('../php/utilities/servercom.php');
require_once ('../php/utilities/tse.php');
require_once ('../php/utilities/signat.php');
require_once ('../php/utilities/operations.php');
require_once ('../php/utilities/layouter.php');
require_once ('../php/utilities/terminals.php');
require_once ('../php/utilities/vouchers.php');
require_once ('../php/utilities/preview.php');
require_once ('../php/utilities/performance.php');
require_once ('../php/utilities/usedfeatures.php');
require_once ('../php/utilities/paymentinfo.php');
require_once ('../php/utilities/fiskalysignresponse.php');
require_once ('../php/utilities/Emailer.php');
require_once ('../php/utilities/HistFiller.php');
require_once ('../php/tasks.php');
