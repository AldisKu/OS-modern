...
function bindModals() {
  ...
  [els.productModal, els.confirmModal, els.menuModal, els.recordsModal].filter(Boolean).forEach(modal => {
...
function buildDisplayPaydesk() {
  const receiptGroups = groupPaydeskItemsAdjacent(state.paydeskReceipt || []);
